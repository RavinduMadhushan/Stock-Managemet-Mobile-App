...
export default class Shopping extends React.Component {
  ...
  render() {
    return (
      <SafeAreaView>
         <Text style={{fontSize: 35, fontWeight: 'bold',textAlign: 'center',marginBottom:20}}>Today You Need to buy</Text>
         <Text style={{fontSize: 25, fontWeight: 'bold',textAlign: 'center'}}>Item :- Quantity</Text>
        <FlatList
