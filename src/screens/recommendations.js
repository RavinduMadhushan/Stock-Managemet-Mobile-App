  ...
  render() {
    return (
      <SafeAreaView>
        ...
        <Text style={{fontSize: 35, fontWeight: 'bold',textAlign: 'center',marginBottom:20}}> You Would love to try</Text>
         <Text style={{fontSize: 25, fontWeight: 'bold',textAlign: 'center'}}>Item :- Probabiliy</Text>
        <FlatList
